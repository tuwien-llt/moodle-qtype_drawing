...
$string['available_student'] = 'Available for Student';
$string['available_trainer'] = 'Available for Trainer';
...
$string['choosebackgroundimage'] = 'Choose a different file';
$string['circle'] = 'Circle';
$string['color'] = 'Color';
$string['color:fill'] = 'Fill Color';
$string['color:highlighter'] = 'Highlighter color';
$string['color:highlighter_help'] = 'Color for marking drawing objects';
$string['color:stroke'] = 'Stroke Color';
$string['colors:config'] = 'Colors Configuration';
$string['colors:config_help'] = 'Configure available colors for drawing';
...
$string['default_student'] = 'Default for Student';
$string['default_trainer'] = 'Default for Trainer';
...
$string['defaultpensize'] = 'Default pen size';
$string['defaultpensize_help'] = 'Set a default pen size for the drawing area (canvas)';
$string['delete'] = 'Delete';
$string['delete_color'] = 'Delete color';
...
$string['drawingcomment'] = 'Created with Freehand drawing qtype for Moodle.';
...
$string['enterstemhere'] = 'Enter the question or a part of a sentence here.';
...
$string['feedback_fullscreen'] = 'Toggle fullscreen feedback editor';
$string['feedbackplaceholder'] = 'Enter feedback for the student...';
$string['file'] = 'File';
$string['font'] = 'Font';
$string['fontsize'] = 'Size';
$string['generalfeedback'] = 'General feedback';
$string['generalfeedback_help'] = 'General feedback help';
$string['global_student_avail'] = 'Color selection available for Student';
$string['global_trainer_avail'] = 'Color selection available for Trainer';
$string['gradequestion'] = 'Grade question';
$string['gradesaved'] = 'Grade saved successfully';
$string['group'] = 'Group';
$string['groupelements'] = 'Group elements';
$string['height'] = 'Height';
$string['hexcode'] = 'Hex Color Code (RGB)';
$string['hidemenu'] = 'Hide menu';
$string['hidequestiontext'] = 'Hide';
$string['highlightertool'] = 'Highlighter Tool';
...
$string['loadingeditor'] = 'Loading the drawing editor…';
$string['loadinggrader'] = 'Loading the grading workspace…';
$string['loadinghint'] = 'Preparing the canvas and tools.';
$string['mark'] = 'Mark';
...
$string['noattempts'] = 'There are no attempts to grade for this question.';
$string['nobackgroundimageselectedyet'] = 'No background image selected yet.';
$string['notadrawingquestion'] = 'This is not a drawing question';
...
$string['previousstudent'] = 'Previous';
$string['privacy:metadata'] = 'The freehand drawing plugin does not store any personal data.';
$string['questionembed'] = 'Display question text inside the drawing area';
$string['questionembed_help'] = 'If enabled, the question text will be displayed inside the drawing area.';
...
$string['unsavedchangesmessage'] = 'You have unsaved changes. What would you like to do?';
$string['view'] = 'View';
$string['viewgrid'] = 'View Grid';
$string['viewmode'] = 'View mode';
$string['viewmode_both'] = 'Show both panels';
$string['viewmode_canvas'] = 'Show drawing only';
$string['viewmode_sidebar'] = 'Show grading panel only';
