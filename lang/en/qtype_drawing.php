...
$string['drawingtoolconfig'] = 'Drawing tool configuration';
$string['drawingtoolconfig_help'] = 'Choose which tools students can use on the drawing canvas. Unchecked tools are hidden from students (teachers keep all tools when annotating during grading). These defaults come from the site administration settings and can be overridden per question.';
...
$string['showtool_toolcircle'] = 'Circle tool';
$string['showtool_toolcircle_help'] = 'Show the circle tool.';
$string['showtool_tooldraw'] = 'Drawing tool';
$string['showtool_tooldraw_help'] = 'Show the freehand drawing (pencil) tool.';
$string['showtool_tooleraser'] = 'Eraser';
$string['showtool_tooleraser_help'] = 'Show the eraser tool.';
$string['showtool_toolhighlighter'] = 'Highlighter tool';
$string['showtool_toolhighlighter_help'] = 'Show the highlighter tool.';
$string['showtool_toolline'] = 'Line tool';
$string['showtool_toolline_help'] = 'Show the straight line tool.';
$string['showtool_toolrect'] = 'Rectangle tool';
$string['showtool_toolrect_help'] = 'Show the rectangle tool.';
$string['showtool_toolselect'] = 'Select tool';
$string['showtool_toolselect_help'] = 'Show the select tool, used to pick and move existing objects.';
$string['showtool_tooltext'] = 'Text tool';
$string['showtool_tooltext_help'] = 'Show the text tool.';
$string['showtool_toolundoredo'] = 'Back / forward (undo / redo)';
$string['showtool_toolundoredo_help'] = 'Show the back and forward (undo and redo) buttons.';
$string['size'] = 'Size';
$string['slot'] = 'Slot';
